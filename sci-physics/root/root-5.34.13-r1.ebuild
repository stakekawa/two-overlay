...
# $Header: /var/cvsroot/gentoo-x86/sci-physics/root/root-5.34.13-r1.ebuild,v 1.1 2013/12/10 16:41:01 jlec Exp $
...
SLOT="0"
LICENSE="LGPL-2.1"
IUSE="+X afs avahi c++0x castor doc emacs examples fits fftw graphviz htmldoc
	kerberos ldap +math +metric minimal mpi mysql odbc +opengl openmp oracle postgres
	prefix pythia6 pythia8 python qt4 +reflex rfio ruby sqlite ssl xinetd xml xrootd"
...
src_prepare() {
	epatch \
		...
		"${FILESDIR}"/${PN}-cernlib-64bit.patch
