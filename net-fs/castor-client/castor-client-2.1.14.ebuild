...
SRC_URI="http://castorold.web.cern.ch/castorold/DIST/CERN/savannah/CASTOR.pkg/2.1.14-*/2.1.14-3/castor-2.1.14-3.tar.gz"
LICENSE="GPL-2"
...
S="${WORKDIR}/castor-2.1.14"

src_compile() {
	export MAJOR_CASTOR_VERSION=2.1
	export MINOR_CASTOR_VERSION=14.3
