...
SRC_URI="x86? ( https://vidyoportal.cern.ch/upload/VidyoDesktopInstaller-sl5-TAG_VD_2_2_1_00419.rpm -> ${P}.rpm )
         amd64? ( https://vidyoportal.cern.ch/upload/VidyoDesktopInstaller-sl564-TAG_VD_2_2_1_00419.rpm -> ${P}_amd64.rpm )"
...
src_install() {
	...
	doexe opt/vidyo/VidyoDesktop/post.sh
	doexe opt/vidyo/VidyoDesktop/RunAsUser
	...
	insinto /
	doins -r * || die
	fperms 755 /usr/bin/VidyoDesktop /opt/vidyo/VidyoDesktop/post.sh /opt/vidyo/VidyoDesktop/RunAsUser \
